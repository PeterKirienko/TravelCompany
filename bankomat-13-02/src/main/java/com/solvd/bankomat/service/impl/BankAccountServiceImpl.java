...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public BigDecimal convertAmount(BankAccount bankAccount, Transaction transaction) {
    ...
    public ExchangeRate getBankPurchaseRateByCurrency(Bank bank, Currency transactionCurrency) {
    ...
    public ExchangeRate getBankSaleRateByCurrency(Bank bank, Currency bankAccountCurrency) {
    ...
    public void verifySecurityInfo(Integer pinToCheck, Card card) throws TransactionException {
        if (card == null) {
    ...
    public void onInvalidPin(Card card) {
    ...
    public void resetCardAttemptsToDefault(Card card) {
